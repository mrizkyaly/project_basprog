<div class="card card-primary card-outline">
	...
	<div class="card-body">
		<?php
			...
			// Form Open
			echo form_open_multipart(base_url('admin/berkas/edit/'.$berkas->id_berkas), 'class="form-horizontal"');
		?>
				...
				<div class="form-group">
					...
					<div class="">
						<input type="text" name="nama" class="form-control" placeholder=""
							value="<?php echo $berkas->nama ?>" required>
					</div>
				</div>
			</div>
			<div class="col-4">
				<div class="form-group">
					...
					<div class="">
						<input type="text" name="link" class="form-control" placeholder=""
							value="<?php echo $berkas->link ?>" required>
					</div>
				</div>
			</div>
			<div class="col-4">
					...
					<div class="">
						<select name="kategori" class="form-control">
							...
							<option value="struktur data"
								<?php if ($berkas->kategori=="struktur data") { echo "selected";} ?>>
				...
				<div class="form-group">
					...
					<div class="">
						<select name="status" class="form-control">
							...
							<option value="draft" <?php if ($berkas->status=="draft") { echo "selected";} ?>>draft
							</option>
						</select>
					</div>
				</div>
